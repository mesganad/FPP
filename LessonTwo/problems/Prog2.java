...
public class Prog2 {
	public static void main(String[] args){
		//column names: productId, name,numInStock,provider,pricePerUnit
		 ...
		 //Splitting colon delimited strings and put these into firstSplitted array.
		 String[] firstSplitted=records.split(":");
		 
		 //Splitting the comma separated strings and put these into secondSplitted array.
		 int i;
		 String[] secondSplitted;
		 System.out.println("Extracted customer IDs are as follows:");
		 
		 for(i=0;i<firstSplitted.length;i++)
		 {
			 secondSplitted=firstSplitted[i].split(",");
				 System.out.println(secondSplitted[0]);
		 }
		}
}
