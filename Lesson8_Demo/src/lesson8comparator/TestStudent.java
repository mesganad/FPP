...
public class TestStudent {
	public static void main(String[] args) {
	  ...
	  // To sort you can use Collections.sort(list,comparator)
	  Collections.sort(list, id);
	  System.out.println("Sort by Student Id using outside Comparator");
	  ...
	  System.out.println("Reversed Sort by Student Score using Anonymous Implementation" );
	  System.out.println(list);
	 ...
	 // Collections.sort(list,(o1,o2)->o1.getName().compareTo(o2.getName()));
	  ...
	  StudentIdComparator id1 = new StudentIdComparator();
